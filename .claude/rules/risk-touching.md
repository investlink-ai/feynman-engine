...
2. **Fail-fast** — Does invalid input (missing stop loss, conviction out of range, negative notional) immediately return `Err(...)`? No silent clamping or defaulting.
